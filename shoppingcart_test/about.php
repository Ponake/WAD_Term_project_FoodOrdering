...
<body> 
	...
	<!-- Top box -->
		...
		<div class="placeholder">
			<div class="parallax-window" data-parallax="scroll" data-image-src="img/foodbg.jpg">
				<div class="tm-header">
		...
		<main>
			<header class="row tm-welcome-section">
				...
				<p class="col-12 text-center">This cooperate project between Phobordee and Ponake for createing food ordering system with mysql, phpmyadmin, and PHP.</p>
			</header>
